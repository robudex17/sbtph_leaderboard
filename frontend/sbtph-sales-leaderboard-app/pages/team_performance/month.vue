<template>
  ...
  <script setup>
   ...
   await marketStore.fetchAgentMarketTargetShipok(query);
   await marketStore.fetchAgentMarketNewDeposit(query);
});
...
watch(() => route.query, async (newQuery, oldQuery) => {
    ...
    await marketStore.fetchAgentMarketTargetShipok(newQuery);
    await marketStore.fetchAgentMarketNewDeposit(newQuery);
