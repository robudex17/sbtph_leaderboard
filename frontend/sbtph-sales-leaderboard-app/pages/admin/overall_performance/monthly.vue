pages/admin/agent_performance/monthly.vue<template>
    ...
    <div v-if="leaderBoardStore.state.loading">
      ...
      <h1 class="text-2xl font-extrabold text-gray-800 mb-3 text-center">Overall Montly Performance  Information</h1>
...
//   const agents = computed(() => manageSalesAgentStore.state.salesAgents);
  ...
  const SelectedTeamMembers = (team) => {
     ...
     navigateTo({path:'/overall_performance/month', query: {team_id: team.team_id, month: team.month, year: team.year, leaderboardOption: 'overall' }})
